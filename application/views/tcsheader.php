...
<header id="header">
	...
	<div style="display:none;" id="iddivLoading" class="loading">Loading&#8230;</div>
		<div class="col-md-5 col-sm-12 col-xs-12 text-center">
		  <div class="logo" ><a  title="SkillAngels" href="<?php echo base_url();?>index.php"><img src="<?php echo base_url(); ?>assets/images/tcsion.svg" alt="SkillAngels" width="300" style="margin-top:25px;"/><!--<img src="images/SUPER_BRAIN_OLYMPIAD.png" alt="G-TEC Gensmart Academy" width="100"/>--></a></div>
		</div>
