...
if (!empty($_POST))
{
	...
	{	
		...
		$qryislogin=islogin_G($username);/* echo $qryislogin;exit; */
	...
	if($type=='ISLOGIN')
	{
		...
		if ($result->num_rows > 0)
		{
			while($row = $result->fetch_assoc()) {
				...
				$_SESSION["conteststartdate"]='2017-11-11';
				$_SESSION["contestenddate"]='2017-11-24';
			}
