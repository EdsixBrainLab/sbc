...
$username = "root";
$password = "net_magic@123";
$ErrorFlag="N";
// Create connection
$conn = new mysqli($servername, $username, $password,"sb","3306");
...
// Data Sample 
$User_ID=$_SESSION['Userdetails']['contest']['userId'];
//echo " Govee    ...".$User_ID;

$User_grade_ID=$_SESSION['Userdetails']['contest']['gradeId'];
$RefreshSource="pageHome"; // default
if(isset($_GET['RS']))
{
$RefreshSource=$_GET['RS'];
}

//$RefreshSource="pageHome"; // default

if(isset($_POST['txtRefreshSource']))
{
	$RefreshSource=$_POST['txtRefreshSource'];
}
...
FROM `vi_Contest_User_Games` WHERE grade_ID=".$User_grade_ID." and User_ID=".$User_ID." ORDER BY skill_id";
...
$sql = "SELECT userid, questionno,status, score,timervalue FROM Vi_UserGameScore WHERE skillid=1 and userid=".$User_ID." order by timervalue desc LIMIT 10";
...
$sql = "SELECT userid, questionno,status, score,timervalue FROM Vi_UserGameScore WHERE skillid=2 and userid=".$User_ID." order by timervalue desc LIMIT 10";
...
$sql = "SELECT userid, questionno,status, score,timervalue FROM Vi_UserGameScore WHERE skillid=3 and userid=".$User_ID." order by timervalue desc LIMIT 10";
...
$sql = "SELECT userid, questionno,status, score,timervalue FROM Vi_UserGameScore WHERE skillid=4 and userid=".$User_ID." order by timervalue desc LIMIT 10";
...
$sql = "SELECT userid, questionno,status, score,timervalue FROM Vi_UserGameScore WHERE skillid=5 and userid=".$User_ID." order by timervalue desc LIMIT 10";
...
// User Profiles 
$sql = "SELECT user_id, User_name AS User_Name,User_Email,DATE_FORMAT(User_DOB,'%d.%m.%Y') User_DOB,User_phone,User_address FROM Vi_Contest_User_Profile WHERE user_id=".$User_ID."";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
		$intRows=$intRows+1;
		$UserDetails=$UserDetails.'{"Name":"'.$row["User_Name"].'","UserID":"'.$row["User_ID"].'","Email":"'.$row["User_Email"].'","DOB":"'.$row["User_DOB"].'","Mobile":"'.$row["User_phone"].'","Address":"'.$row["User_address"].'"}';
		$Name=$row["User_Name"];
		$UserID=$row["User_ID"];
...
'beforeShow': function() { 
   iframeoriginalurl=$(".fancybox-iframe").attr("src");
$(".fancybox-inner").css("top","50%").css("left","50%").css("position","absolute");
$(".fancybox-outer").css("background","url(../images/fancybox_overlay.png)");
$(".fancybox-iframe").attr("src","images/fancybox_loading.gif");
 },
  'afterShow': function() { 
$(".fancybox-inner").css("top","").css("left","").css("position","");
$(".fancybox-outer").css("background","");
 $(".fancybox-iframe").attr("src", iframeoriginalurl);
 },
'beforeClose': function() { //alert('Refresh yet to be accommodated'+xyz);
window.location.assign("main.php?User_ID="+ 152 +"&RS="+xyz);
 },
    'closeClick': true
});
</script>
...
<div class="pageheader">           
		   <div class="navbar-header">
			...
			<form id="frmContest" action="" method="post">
			<div class="pagemenu">
		   <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
				<input id="txtRefreshSource" name="txtRefreshSource" type="hidden" value="">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a id="Dashboard" class="Dashboard menu" >Dashboard<i class="fa fa-th-large fa-fw"></i></a>
                        </li>
                        <li>
                            <a id="MyGames" class="MyGames  menu" >My Games<i class="fa fa-gamepad fa-fw"></i></a>
                        </li>
                        <li>
                            <a id="MyReports" class="MyReports  menu" >My Reports<i class="fa fa-table fa-fw"></i></a>
                        </li>
                        <li>
                            <a id="MyProfile" class="MyProfile  menu">My Profile<i class="fa fa-edit fa-fw"></i></a>
                        </li
						 <li>
                            <a href="https://b2c.skillangels.com/View/User/Dashboard.php" class="menu">Training<i class="fa fa-edit fa-fw"></i></a>
                        </li>
                    </ul>
    	...
    	<div class="row">
                	<div class="col-lg-3 col-md-6 superBrainWrapper">
                    	<div class="superBrainContainer">
							...
							<span>Contest Date :</span> {{ContestDate}}
    	...
    	<div class="row">
            ...
            <div class="col-lg-6 footerLinks">
    			<ul>
                    ...
                    <li><a href="">Terms of Services</a><span>|</span></li>
