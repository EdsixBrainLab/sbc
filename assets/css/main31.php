...
window.location.assign("main.php?User_ID="+ <?php echo $User_ID?> +"&RS="+xyz);
 },
    'closeClick': true
		   ...
		   <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a id="MyProfile" class="MyProfile  menu" ">My Profiles<i class="fa fa-edit fa-fw"></i></a>
                        </li>
                    </ul>
...
<div class="DashboardPager pageHomePagerHide mygameshide myreporthide myprofilehide">
      			...
      			<div class="col-lg-12">
        				<div class="contentbox">
                			...
                			<div class="gameBox MemoryGame" >
                    			...
                    			<a class="viewMoreBtn gamepopup {{MPlayNow}}"  href="{{MGamePlayLink}}" title="{{MPlaytooltipstatus}}">{{MPlayText}}</a>
                			</div>
  ...
  <span class="{{ x.classApply}}"></span></li>
                			...
                			<div class="gameBox VisualProcessingGame">
                    			...
                    			<a class="gamepopup viewMoreBtn gamelink memorygame memorygame.iframe {{VPPlayNow}}" href="{{VPGamePlayLink}}" title="{{VPPlaytooltipstatus}}">{{VPPlayText}}</a>
                			</div>
                            <div class="earnedStars">
							  <div  ng-controller="Stars">
       <ul>
  ...
  <span class="{{ x.classApply}}"></span></li>
                			...
                			<div class="gameBox FocusGame">
                    			...
                    			<a class="gamepopup viewMoreBtn gamelink memorygame memorygame.iframe {{FAPlayNow}}" href="{{FAGamePlayLink}}" title="{{FAPlaytooltipstatus}}">{{FAPlayText}}</a>
                			</div>
  ...
  <span class="{{ x.classApply}}"></span></li>
                			...
                			<div class="gameBox ProblemSolvingGame">
								...
								<a class="gamepopup viewMoreBtn gamelink memorygame memorygame.iframe {{PSPlayNow}}" href="{{PSGamePlayLink}}" title="{{PSPlaytooltipstatus}}">{{PSPlayText}}</a>
...
<div  ng-controller="Stars">
  ...
  <span class="{{ x.classApply}}"></span></li>
                			...
                			<div class="gameBox LinguisticsGame">
								...
								<a class="gamepopup viewMoreBtn gamelink memorygame memorygame.iframe {{LIPlayNow}}" href="{{LIGamePlayLink}}" title="{{LIPlaytooltipstatus}}">{{LIPlayText}}</a>
